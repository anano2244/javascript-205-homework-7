...
გახსენით https://github.com/JavaScriptADI/javascript-205-homework-7 ბრაუზერში.
...
თუ უკვე აღარ ხართ თქვენს ფოლდერში, გამოტოვეთ `cd ../..` ხაზი — შეამოწმეთ `pwd`-ით, რომ `javascript-205-homework-7`-ში ხართ.
...
2. შეამოწმეთ გვერდის თავზე მოცემული ოთხი ჩამონათვალი:
   * **base repository:** `JavaScriptADI/javascript-205-homework-7` და **base:** `main`
   * **head repository:** `<your-username>/javascript-205-homework-7` და **compare:** `<your-username>`
3. **სათაური:** "Homework 7 - Your Name" თქვენი ნამდვილი სახელით, მაგალითად "Homework 7 - Nino Beridze".
...
> **კარგია, რომ იცოდეთ**
>
> * **თავდაპირველ** რეპოზიტორიაში (`JavaScriptADI/javascript-205-homework-7`) push ვერ გააკეთებთ და მისი `main` ბრენჩი დაცულია. ეს ასეც უნდა იყოს: თქვენი ნამუშევარი ყოველთვის თქვენს fork-ში, თქვენს ბრენჩზე მიდის და თავდაპირველ რეპოზიტორიას მხოლოდ Pull Request-ით სწვდება.
...
* [ ] 2–6 სავარჯიშოებში ყოველი ფუნქცია, რომელიც დაწერეთ, ისრიანი ფუნქციაა
* [ ] არსად არაა `map` / `filter` / `reduce` / `forEach`, ნაგულისხმევი პარამეტრები, `var` და `prompt()`
* [ ] ახსნები და ვარაუდები კომენტარებშია: სავარჯიშო 2 (`half`), სავარჯიშო 4, სავარჯიშო 5 (A და B ნაწილები) და სავარჯიშო 6 (A ნაწილი)
* [ ] თქვენი ფოლდერის გარეთ არცერთი ფაილი არ შეცვლილა
* [ ] თქვენი ბრენჩი თქვენი GitHub-ის მომხმარებლის სახელით არის დასახელებული
* [ ] Pull Request გახსნილია სათაურით "Homework 7 - Your Name"

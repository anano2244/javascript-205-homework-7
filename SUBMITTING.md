...
Open https://github.com/JavaScriptADI/javascript-205-homework-7 in your browser.
...
```text
https://github.com/<your-username>/javascript-205-homework-7
```
...
```bash
git clone https://github.com/<your-username>/javascript-205-homework-7.git
cd javascript-205-homework-7
```
...
If you are not inside your folder any more, skip the `cd ../..` line — check with `pwd` that you are in `javascript-205-homework-7`.

You should see something like:

```text
[<your-username> 3f2a9c1] Add homework 7
 6 files changed, 90 insertions(+)
...
remote: Create a pull request for '<your-username>' on GitHub by visiting:
remote:      https://github.com/<your-username>/javascript-205-homework-7/pull/new/<your-username>
```
...
2. Check the four dropdowns at the top of the page:
   * **base repository:** `JavaScriptADI/javascript-205-homework-7` and **base:** `main`
   * **head repository:** `<your-username>/javascript-205-homework-7` and **compare:** `<your-username>`
3. **Title:** "Homework 7 - Your Name" with your real name, for example "Homework 7 - Nino Beridze".
...
> **Good to know**
>
> * You cannot push to the **original** repository (`JavaScriptADI/javascript-205-homework-7`) and its `main` branch is protected. That is expected: your work always goes to your fork, on your branch, and reaches the original repository only through a Pull Request.
...
* [ ] In exercises 2–6, every function I wrote is an arrow function
* [ ] No `map` / `filter` / `reduce` / `forEach`, no default parameters, no `var`, no `prompt()`
* [ ] My explanations and predictions are in comments: exercise 2 (`half`), exercise 4, exercise 5 (Parts A and B) and exercise 6 (Part A)
* [ ] No files outside your own folder were changed
* [ ] Your branch is named after your GitHub username
* [ ] The Pull Request is open with the title "Homework 7 - Your Name"
